...
VENV_NAME ?= fls_sat_verif#OPT Name of conda virtual environment (overridden by VENV_DIR)

# Default values used below (caution: keep values in sync with above)
DEFAULT_VENV_NAME = fls_sat_verif#
...
#	\rm -f docs/fls_sat_verif.rst
#	\rm -f docs/modules.rst
#	${PREFIX}sphinx-apidoc -o docs/ src/fls_sat_verif
